...
namespace Viewer3D_Blendshapes
{
	...
	public:
		...
		void createShaders()
		{
			...
			PhongProgramID = LoadShaders("../3DViewer_Blendshapes/shaders/Fresnel.vs", "../3DViewer_Blendshapes/shaders/Fresnel.fs");	
			//SimpleShaderID = LoadShaders("../3DViewer_Blendshapes/shaders/simpleShader.vs", "../3DViewer_Blendshapes/shaders/circle.fs");
		}
