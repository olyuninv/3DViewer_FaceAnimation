...
using namespace glm;
using namespace std;
using namespace Viewer3D_Blendshapes;
...
double time_d = 0, dt;// Current time and enlapsed time
...
void addToObjectBuffer(Viewer3D_Blendshapes::CGObject *cg_object)
{
...
void addToIndexBuffer(Viewer3D_Blendshapes::CGObject *cg_object)
{
	int IBOindex = cg_object->startIBO;
...
Viewer3D_Blendshapes::CGObject loadObjObject(vector<objl::Mesh> meshes, bool addToBuffers, bool subjectToGravity, vec3 initTransformVector, vec3 initScaleVector, vec3 color, float coef, CGObject* parent)
{
	Viewer3D_Blendshapes::CGObject object = Viewer3D_Blendshapes::CGObject();
...
void createFaces()
{
	...
	if (usingLowRes)
	{
		dirName = "../3DViewer_Blendshapes/meshes/Low-res Blendshape Model";
		neutralFileName = "Mery_jaw_open.obj";
	}
	else
	{
		dirName = "../3DViewer_Blendshapes/meshes/High-res Blendshape Model";
...
void createObjects()
{
	...
	/*const char* boyFileName = "../3DViewer_Blendshapes/meshes/Head/male head.obj";
	...
	/*const char* cubeFileName = "../3DViewer_Blendshapes/meshes/Cube/cube.obj";
	...
	const char* sphereFileName = "../3DViewer_Blendshapes/meshes/Sphere/sphere.obj";
...
void init()
{
	...
	readAnimationFile("../3DViewer_Blendshapes/meshes/blendshape_animation.txt");
...
void display()
{
	...
	{
		// update weights
		double deltaTime = time_d - animationStartTime;
